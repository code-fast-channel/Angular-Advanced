...
import { ReusableFormForDragDropComponent } from './Reusable-Examples/reusable-form-for-drag-drop/reusable-form-for-drag-drop.component';
import { ReusableFormsAdvancedComponent } from './Reusable-Examples/advanced-reusable-form-example/reusable-forms-advanced/reusable-forms-advanced.component';
import { ReusableFormAdvancedDesignComponent } from './Reusable-Codes/common-components/advanced-reusable-form/reusable-form-advanced-design/reusable-form-advanced-design.component';
import { ErrMsgComponent } from './Reusable-Codes/common-components/common-form/err-msg/err-msg.component';
import { CommonTableNewAdvancedComponent } from './Reusable-Codes/common-components/common-table-new-advanced/common-table-new-advanced.component';
import { AdvamcedReusableTableExampleComponent } from './Reusable-Examples/advamced-reusable-table-example/advamced-reusable-table-example.component';
@NgModule({
  declarations: [
    AppComponent,
    ...
    ReusableFormForDragDropComponent,
    ReusableFormsAdvancedComponent,
    ReusableFormAdvancedDesignComponent,
    ErrMsgComponent,
    CommonTableNewAdvancedComponent,
    AdvamcedReusableTableExampleComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
